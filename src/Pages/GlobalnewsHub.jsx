  ...
  useEffect(() => {
    const getSelectedApi = async () => {
      ...
      try {
        ...
        const [{ data: _guardian }] = await Promise.all([guardianApi.get("/search?api-key=583de15d-29de-4ff8-89a3-ef7e8f767693", { params }),
        ]);
        ...
        setFetchedData({ guardian: _guardian.response.results });
